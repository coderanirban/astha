...
$get_temples = "SELECT * FROM temples";
$run_temples = mysqli_query($con,$get_temples);
$count_temples = mysqli_num_rows($run_temples);

$get_customers = "SELECT * FROM customers";
$run_customers = mysqli_query($con,$get_customers);
$count_customers = mysqli_num_rows($run_customers);

/*$get_p_categories = "SELECT * FROM temple_categories";
$run_p_categories = mysqli_query($con,$get_p_categories);
$count_p_categories = mysqli_num_rows($run_p_categories);*/


$get_total_orders = "SELECT * FROM puja_orders";
$run_total_orders = mysqli_query($con,$get_total_orders);
$count_total_orders = mysqli_num_rows($run_total_orders);


$get_pending_orders = "SELECT * FROM puja_orders WHERE order_status='pending'";
$run_pending_orders = mysqli_query($con,$get_pending_orders);
$count_pending_orders = mysqli_num_rows($run_pending_orders);

$get_completed_orders = "SELECT * FROM puja_orders WHERE order_status='Complete'";
...
if(isset($_GET['insert_temple'])){

include("insert_temple.php");

}

if(isset($_GET['view_temples'])){

include("view_temples.php");

}

if(isset($_GET['delete_temple'])){

include("delete_temple.php");

}

if(isset($_GET['edit_temple'])){

include("edit_temple.php");
...
if(isset($_GET['insert_bramhin'])){

include("insert_bramhin.php");

}

if(isset($_GET['view_bramhins'])){

include("view_bramhins.php");

}

if(isset($_GET['delete_bramhin'])){

include("delete_bramhin.php");

}

if(isset($_GET['edit_bramhin'])){

include("edit_bramhin.php");
